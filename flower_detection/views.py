...
#-------------------calling up the trained model for prediction then using the path of the stored image in database processinf the image to determine flower type -------------
		model = load_model(r"C:\Users\rusha\Documents\FLOWER RECOGNITION\Pull from Github\flower-detection\flower_detection\save\flower_api_model.h5")
		validation_image = image.load_img(os.path.join("C:/Users/rusha/Documents/FLOWER RECOGNITION/final/Trial model/media",variable) , target_size=(180,180))
